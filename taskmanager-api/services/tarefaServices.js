...
async function criarQuery({titulo, descricao, status, 
...
async function atualizarQuery(id, {titulo, descricao, status, 
    prioridade, data_entrega}) {
...
module.exports = {
    listarQuery, criarQuery, atualizarQuery, deletarQuery
};
